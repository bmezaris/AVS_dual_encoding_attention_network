...
import evaluation
import util.data_provider_BERT_w2v as data
from util.vocab import Vocabulary
from util.text2vec import get_text_encoder
from ATT_w2v_bert_model import get_model, get_we_parameter
...
def parse_args():
    ...
    # model
    parser.add_argument('--model', type=str, default='dual_encoding_ATT_w2v_bert',
                        help='model name. (default: dual_encoding)')
    ...
    parser.add_argument('--cv_name', default='DG_ATT_w2v_bert', type=str, help='')
