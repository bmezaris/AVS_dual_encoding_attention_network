...
def main(argv=None):
    if argv is None:
        argv = sys.argv[1:]
        #   /home/dgalanop/Desktop/CERTH_VisualSearch_dualDense/ 3dresnet--34_activenet400,flatten0_output,os
    # --rootpath /home/dgalanop/Desktop/CERTH_VisualSearch_dualDense/ --collection 3D_TGIF_MSR_VTT_train  --feature 3dresnet--34_activenet400,flatten0_output,os
