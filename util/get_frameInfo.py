...
def main(argv=None):
    ...
    parser.add_option("--collection", default="iacc.3", type="string", help="collection name")
    parser.add_option("--feature", default="pyresnet-152_imagenet11k,flatten0_output,os", type="string", help="feature name")
    parser.add_option("--overwrite", default=0, type="int", help="overwrite existing file (default=0)")
    # --collection IACC.3_DenseSampling_OLD --feature inceprion-bn_imagenet21k,flatten0_output,os
    (options, args) = parser.parse_args(argv)
    return process(options)
#--collection IACC.3_DenseSampling_OLD --feature inceptionBN-Imagenet-21k,flatten0_output,os
